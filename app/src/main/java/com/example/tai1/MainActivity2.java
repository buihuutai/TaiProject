...
public class MainActivity2 extends AppCompatActivity {
    ...
    private ImageView backButton, temperatureWarning, humidityWarning, brightnessWarning, airConditionerImage, decreaseTemperature, increaseTemperature, fanImage, lightImage;
